...
const faqs = [
  {
    ...
    answer: "We offer sizes ranging from XS to XXL. Please check our size guide for exact measurements.",
  },
  {
    question: "How can I track my order?",
    answer: "Once your order is shipped, we will email you a tracking link so you can monitor your delivery status.",
  },
  {
  ...
  },
  {
    ...
    answer: "You can modify or cancel your order within 24 hours after placing it. Contact our support team for assistance.",
  },
];
...
const Faqs = () => {
  ...
  return (
    <div className="bg-[#e9e2d8] text-white py-12 px-6 md:px-16 ">
      <h2 className="text-3xl font-bold text-center text-[#B8860B] mb-8">Frequently Asked Questions</h2>
