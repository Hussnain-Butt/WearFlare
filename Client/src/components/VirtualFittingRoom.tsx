  ...
  return (
    <div className="min-h-screen w-full relative background z-10">
      ...
      <div className="relative flex flex-col items-end p-2">
        ...
        <img src={boy1} alt="Model" className="h-[300px] rounded-md shadow-xl mt-5 mr-5" />

        {/* Button centered below the image */}
        <div className="w-full flex justify-center mt-5">
          <Button className="bg-white hover:bg-white text-[#c8a98a] text-lg font-medium py-4 px-10 rounded-full">
            Try own
          </Button>
        </div>
      </div>
