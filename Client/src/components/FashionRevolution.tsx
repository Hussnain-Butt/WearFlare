...
import computerizedImage from "../../public/computerized pic.png"
...
const FashionRevolution = () => {
  ...
  <div className="bg-[#d6d0c4] p-8 md:p-12 md:w-1/2">
    <h2 className="text-2xl md:text-3xl font-serif  font-bold text-[#3a3a3a] mb-4">Join the Revolution</h2>
  ...
  <div className="md:w-1/2 relative overflow-hidden">
    <img
      src={computerizedImage}
      alt="Virtual fitting room devices"
