            ...
            <div className="col-span-6 flex flex-col items-center justify-center">
              <div className="relative w-full h-[400px] flex justify-center">
                <div className="absolute flex space-x-20">
                  <img src={ThreeDImage} alt="Male Avatar" className="h-[400px] object-contain" />
                </div>
              ...
              <Button className="mt-4 bg-[#B8860B]  text-white px-8 py-2 absolute  rounded-full">
                Customize Avatar
              </Button>
            </div>
            ...
            <div className="col-span-3 flex flex-col justify-between">
              <div className="">
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <span className="text-white font-semibold text-lg">{waistSize} cm</span>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-5 flex flex-col">
              ...
              <div className="border border-[#B8860B] rounded-lg aspect-square flex flex-col items-center justify-center bg-[#B8860B] hover:bg-[#A8860B] transition-all text-white">
                ...
                <Button
                  variant="outline"
                  className="mt-4 bg-[#B8860B] hover:bg-[#A8860B] text-white border-none py-2 px-4"
                >
            ...
            <div className="md:col-span-7 flex flex-col">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {['height', 'weight', 'chest', 'waist', 'hips'].map((field) => (
                  <div key={field}>
                    <Label htmlFor={field} className="text-white text-sm capitalize">
                      {field} (cm)
                    </Label>
                    <Input
                      id={field}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {['skinTone', 'hairColor', 'eyeColor', 'bodyType'].map((feature) => (
                  <div key={feature}>
                    <Label htmlFor={feature} className="text-white text-sm capitalize">
