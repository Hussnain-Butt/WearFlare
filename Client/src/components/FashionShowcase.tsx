...
import girl from '/girls.png'
import boys from '/boys.png'
import boy from '/booy.png'
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-3 space-y-6 animate-slide-in">
            ...
            <div className="bg-white p-4 space-y-2">
              <div className="uppercase text-xs tracking-widest font-medium text-fashion-charcoal">
                Brown Coat
              </div>
              <div className="text-lg font-light">5600 Rs</div>
              <div className="flex flex-col gap-2">
                <button className="fashion-button">Quick View</button>
                <button className="fashion-button">Add to Cart</button>
              </div>
              <div className="pt-2">
                <button className="fashion-button border border-fashion-lightgray w-full">
                  See More Collection
                </button>
              </div>
            </div>
          ...
          {/* Right sidebar */}
          <div
            className="md:col-span-3 flex flex-col gap-6 animate-slide-in"
