...
// import WomensComponents from '@/components/WomensComponent' // Uncomment if used
...
const Women: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setError(null)
    axios
      .get(`${API_BASE_URL}/api/products?gender=women`)
      .then((res) => {
    ...
    <div className="min-h-screen bg-[#eee8e3]">
      ...
      <div className="w-full py-3 px-4 sm:px-8 bg-[#e5dfd8] flex justify-between items-center sticky top-0 z-10 shadow-sm">
        <div className="flex items-center space-x-1">
          ...
          <span className="text-xs sm:text-sm text-gray-900 font-medium">WOMEN</span>
        </div>
      ...
      {/* Show Newsletter always if 'All' is not selected, or only when 'All' is selected? Adjust logic if needed */}
